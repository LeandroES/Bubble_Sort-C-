...
int main()
{
    ...
    ifstream inFile14;
    ifstream inFile15;
    inFile1.open("D:\\WorkSpaces\\C++\\5th semester\\FLP\\Proyecto\\data\\100.txt");
    if (!inFile1) {
        cout << "Unable to open file";
        exit(1); // terminate with error
    }
    inFile2.open("D:\\WorkSpaces\\C++\\5th semester\\FLP\\Proyecto\\data\\1000.txt");
    if (!inFile2) {
        cout << "Unable to open file";
        exit(1); // terminate with error
    }
    inFile3.open("D:\\WorkSpaces\\C++\\5th semester\\FLP\\Proyecto\\data\\2000.txt");
    if (!inFile3) {
        cout << "Unable to open file";
        exit(1); // terminate with error
    }
    inFile4.open("D:\\WorkSpaces\\C++\\5th semester\\FLP\\Proyecto\\data\\3000.txt");
    if (!inFile4) {
        cout << "Unable to open file";
        exit(1); // terminate with error
    }
    inFile5.open("D:\\WorkSpaces\\C++\\5th semester\\FLP\\Proyecto\\data\\4000.txt");
    if (!inFile5) {
        cout << "Unable to open file";
        exit(1); // terminate with error
    }
    inFile6.open("D:\\WorkSpaces\\C++\\5th semester\\FLP\\Proyecto\\data\\5000.txt");
    if (!inFile6) {
        cout << "Unable to open file";
        exit(1); // terminate with error
    }
    inFile7.open("D:\\WorkSpaces\\C++\\5th semester\\FLP\\Proyecto\\data\\6000.txt");
    if (!inFile7) {
        cout << "Unable to open file";
        exit(1); // terminate with error
    }
    inFile8.open("D:\\WorkSpaces\\C++\\5th semester\\FLP\\Proyecto\\data\\7000.txt");
    if (!inFile8) {
        cout << "Unable to open file";
        exit(1); // terminate with error
    }
    inFile9.open("D:\\WorkSpaces\\C++\\5th semester\\FLP\\Proyecto\\data\\8000.txt");
    if (!inFile9) {
        cout << "Unable to open file";
        exit(1); // terminate with error
    }
    inFile10.open("D:\\WorkSpaces\\C++\\5th semester\\FLP\\Proyecto\\data\\9000.txt");
    if (!inFile10) {
        cout << "Unable to open file";
        exit(1); // terminate with error
    }
    inFile11.open("D:\\WorkSpaces\\C++\\5th semester\\FLP\\Proyecto\\data\\10000.txt");
    if (!inFile11) {
        cout << "Unable to open file";
        exit(1); // terminate with error
    }
    inFile12.open("D:\\WorkSpaces\\C++\\5th semester\\FLP\\Proyecto\\data\\20000.txt");
    if (!inFile12) {
        cout << "Unable to open file";
        exit(1); // terminate with error
    }
    inFile13.open("D:\\WorkSpaces\\C++\\5th semester\\FLP\\Proyecto\\data\\30000.txt");
    if (!inFile13) {
        cout << "Unable to open file";
        exit(1); // terminate with error
    }
    inFile14.open("D:\\WorkSpaces\\C++\\5th semester\\FLP\\Proyecto\\data\\40000.txt");
    if (!inFile14) {
        cout << "Unable to open file";
        exit(1); // terminate with error
    }
    inFile15.open("D:\\WorkSpaces\\C++\\5th semester\\FLP\\Proyecto\\data\\50000.txt");
    if (!inFile15) {
        cout << "Unable to open file";
        exit(1); // terminate with error
    }
    ...
    bubbleSort(reinterpret_cast<int *>(a9), 8000);
    ...
    bubbleSort(reinterpret_cast<int *>(a10), 9000);
    ...
    bubbleSort(reinterpret_cast<int *>(a11), 10000);
    ...
    bubbleSort(reinterpret_cast<int *>(a12), 20000);
    ...
    bubbleSort(reinterpret_cast<int *>(a13), 30000);
    ...
    bubbleSort(reinterpret_cast<int *>(a14), 40000);
    ...
    bubbleSort(reinterpret_cast<int *>(a15), 50000);
